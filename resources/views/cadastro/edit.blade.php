        ...
        <div class="container">
            ...
            <form action="{{ route('cadastro.store') }}" method="POST"
                ...
                <div class="mb-3 col-sm-12">
                    ...
                    <input type="text" class="form-control" id="nome" name="nome" value="{{$cadastro->nome}}" aria-describedby="nome"
                        required>
                </div>
                <div class="mb-3 col-sm-12">
                    <label for="apelido" class="form-label">Como gosta de ser chamada</label>
                    <input type="text" class="form-control" id="apelido" name="apelido" value="{{$cadastro->apelido}}" aria-describedby="apelido"
                        required>
                </div>
                <div class="mb-3 col-sm-12">
                    <label for="email" class="form-label">Email</label>
                    <input type="email" class="form-control" id="email" name="email" value="{{$cadastro->email}}" aria-describedby="email"
                        required>
                </div>
                <div class="mb-3 col-sm-12">
                    <label for="endereco" class="form-label">Digite seu endereço</label>
                    <input type="text" class="form-control" id="endereco" name="endereco" value="{{$cadastro->endereco}}" aria-describedby="endereco"
                        required>
                </div>
                <div class="mb-3 col-sm-12  col-md-4 col-lg-3">
                    <label for="data_nascimento" class="form-label">Data de nascimento</label>
                    <input type="text" class="form-control date" id="data_nascimento" name="data_nascimento" value="{{$cadastro->data_nascimento}}"
                        aria-describedby="data_nascimento" required>
                </div>
                <div class="mb-3 col-sm-12  col-md-4 col-lg-3">
                    <label for="identidade" class="form-label">Identidade</label>
                    <input type="text" class="form-control" id="identidade" name="identidade" value="{{$cadastro->identidade}}"
                        aria-describedby="identidade" required>
                </div>
                <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                    <label for="cpf" class="form-label">CPF</label>
                    <input type="text" class="form-control cpf" id="cpf" name="cpf" value="{{$cadastro->cpf}}" aria-describedby="cpf"
                        required>
                </div>
                <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                    <label for="telefone" class="form-label">Telefone</label>
                    <input type="text" class="form-control phone_with_ddd" id="telefone" name="telefone" value="{{$cadastro->telefone}}"
                        aria-describedby="telefone" required>
                </div>
                <div class="mb-3 col-sm-12  col-md-4 col-lg-3">
                    <label for="estado_civil" class="form-label">Estado Civil</label>
                    <select name="estado_civil" value="{{$cadastro->estado_civil}}" class="form-select" aria-label="Estado civil" required>
                ...
                <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                    ...
                    <select name="filhos" value="{{$cadastro->filhos}}" class="form-select" onchange="onChangeOption(this,['qtd_filhos'])" aria-label="Tem filhos" required>
                        <option value="" selected>Escolha uma opção</option>
                ...
                <div class="mb-3 col-sm-12  col-md-4 col-lg-3">
                    ...
                    <input type="text" class="form-control" id="qtd_filhos" name="qtd_filhos" value="{{$cadastro->qtd_filhos}}"
                        aria-describedby="qtd_filhos">
                </div>
                <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                    <label for="profissao" class="form-label">Profissão</label>
                    <input type="text" class="form-control" id="profissao" name="profissao" value="{{$cadastro->profissao}}"
                        aria-describedby="profissao" required>
                </div>
                <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                    <label for="numero_camisa" class="form-label">Número da camisa</label>
                    <input type="number" class="form-control" id="numero_camisa" name="numero_camisa" value="{{$cadastro->numero_camisa}}"
                        aria-describedby="numero_camisa" required>
                </div>
                <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                    <label for="posicao" class="form-label">Posição que joga</label>
                    <select name="posicao" value="{{$cadastro->posicao}}" class="form-select" aria-label="Posição que joga" required>
                        <option value="" selected>Escolha uma opção</option>
                ...
                <div class="mb-3 col-sm-12  col-md-4 col-lg-3 d-none">
                    ...
                    <input type="text" class="form-control" id="qtd_atividade_semana" name="qtd_atividade_semana" value="{{$cadastro->qtd_atividade_semana}}"
                        aria-describedby="qtd_atividade_semana">
                </div>
                <div class="mb-3 col-sm-12  col-md-4 col-lg-3 d-none">
                    <label for="atividade_fisica" class="form-label">Quais atividades?</label>
                    <select name="atividade_fisica[]" value="{{$cadastro->atividade_fisica}}" id="atividade_fisica" multiple class="form-select" aria-label="Quais atividades você pratiica">
                        <option value="" selected>Escolha uma opção</option>
                ...
                <div class="mb-3 col-sm-12  col-md-4 col-lg-3 d-none">
                    ...
                    <input type="text" class="form-control" id="plano_saude" name="plano_saude" value="{{$cadastro->plano_saude}}"
                        aria-describedby="plano_saude">
                </div>
                <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                    <label for="tem_alergia" class="form-label">Tem alergia?</label>
                    <select name="tem_alergia" value="{{$cadastro->tem_alergia}}" onchange="onChangeOption(this,['alergia'])" class="form-select" aria-label="Faz terapia" required>
                        <option value="" selected>Escolha uma opção</option>
                        <option value="Sim">Sim</option>
                        <option value="Não">Não</option>
                    </select>
                ...
                <div class="mb-3 col-sm-12  col-md-4 col-lg-3 d-none">
                    ...
                    <input type="text" class="form-control" id="alergia" name="alergia" value="{{$cadastro->alergia}}" aria-describedby="alergia">
                </div>
                <div class="col-12">
