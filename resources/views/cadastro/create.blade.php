        ...
        <div class="container">
            ...
            <form action="{{route('cadastro.store')}}" class="form mb-5">
                ...
                <div class="mb-3 col-sm-12">
                    ...
                    <input type="text" class="form-control" id="apelido" name="apelido" aria-describedby="apelido" required>
                </div>
                <div class="mb-3 col-sm-12">
                ...
                <div class="mb-3 col-sm-12">
                    ...
                    <input type="text" class="form-control" id="endereco" name="endereco" aria-describedby="endereco" required>
                </div>
                <div class="row">
                    <div class="mb-3 col-sm-12  col-md-6 col-lg-4">
                        <label for="identidade" class="form-label">Data de nascimento</label>
                        <input type="date" class="form-control" id="identidade" name="identidade" aria-describedby="identidade" required>
                    </div>
                    <div class="mb-3 col-sm-12  col-md-6 col-lg-4">
                        <label for="identidade" class="form-label">Identidade</label>
                        <input type="text" class="form-control" id="identidade" name="identidade" aria-describedby="identidade" required>
                    </div>
                    <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                        <label for="cpf" class="form-label">CPF</label>
                        <input type="text" class="form-control" id="cpf" name="cpf" aria-describedby="cpf" required>
                    </div>
                    <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <select name="filhos" class="form-select" onchange="qtd_filhos(this)" aria-label="Tem filhos" required>
                            <option selected>Escolha uma opção</option>
                    ...
                    <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <input type="text" class="form-control" id="profissao" name="profissao" aria-describedby="profissao" required>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                        ...
                        <input type="number" class="form-control" id="numero_camisa" name="numero_camisa" aria-describedby="numero_camisa" required>
                    </div>
                    <div class="mb-3 col-sm-12 col-md-6 col-lg-4">
                ...
                <div class="row">
                    <div class="mb-3 col-sm-12  col-md-6 col-lg-4">
                        ...
                        <select name="nutricionista" class="form-select" aria-label="Faz acompanhamento com nutricionista" required>
                            <option selected>Escolha uma opção</option>
                            <option value="Sim">Sim</option>
                            <option value="Não">Não</option>
                        </select>
                    ...
                    <div class="mb-3 col-sm-12  col-md-6 col-lg-4">
                        ...
                        <select name="faz_atividade" class="form-select" onchange="atividade_fisica(this)" aria-label="Faz física" required>
                            <option selected>Escolha uma opção</option>
                            <option value="Sim">Sim</option>
                            <option value="Não">Não</option>
                        </select>
                ...
                <div class="row">
                    <div class="mb-3 col-sm-12  col-md-6 col-lg-4">
                        ...
                        <select name="tem_plano" class="form-select" aria-label="Tem plano de saúde" required>
                            <option selected>Escolha uma opção</option>
                            <option value="Sim">Sim</option>
                            <option value="Não">Não</option>
                        </select>
                    ...
                    <div class="mb-3 col-sm-12  col-md-6 col-lg-4">
                        ...
                        <select name="tem_alergia" class="form-select" aria-label="Faz terapia" required>
                            <option selected>Escolha uma opção</option>
                            <option value="Sim">Sim</option>
                            <option value="Não">Não</option>
                        </select>
